...
const UPGRADES = {
	"icespear1": {
		...
		"details": "A spear of ice is thrown at the closest enemy",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "weapon"
	},
	...
	"icespear4": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Ice Spear",
		"details": "2 additional Ice Spears are thrown",
		"level": "Level: 4",
	...
	"javelin2": {
		"icon": WEAPON_PATH + "javelin_3_new_attack.png",
		"displayname": "Javelin",
		"details": "The javelin will attack 2 enemies per attack",
		"level": "Level: 2",
	...
	"javelin3": {
		"icon": WEAPON_PATH + "javelin_3_new_attack.png",
		"displayname": "Javelin",
		"details": "The javelin will attack 3 enemies per attack",
		"level": "Level: 3",
	...
	"tornado1": {
		...
		"displayname": "Tornado",
		"details": "A tornado heads in the players direction",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "weapon"
	},
